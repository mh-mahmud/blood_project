                ...
                <div class="col-lg-8 col-md-8">
                    <div class="blog-details-wrapper">
                        <div class="blog-details__thumb">
                            <img src="{{ getImage('assets/images/frontend/blog/'.$blog->data_values->image,'626x430') }}" alt="@lang('Blog Image')">
                        ...
                        <div class="widget">
                            ...
                            <ul class="small-post-list">
                                @foreach($blogs as $post)
                                    <li class="small-post">
                                        <div class="small-post__thumb"><img src="{{ getImage('assets/images/frontend/blog/'. $post->data_values->image,'626x430') }}" alt="@lang('Blog Image')"></div>
                                        <div class="small-post__content">
                                            <h5 class="post__title"><a href="{{ route('blog.details',slug($post->data_values->title)) }}">{{__($post->data_values->title)}}</a></h5>
                                        </div>
                                    </li>
                                @endforeach
                            </ul>
